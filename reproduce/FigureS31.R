...
library(ggplot2)
sampleID = 151507
df = read.csv(file = paste0("application/DLPFCdata/", sampleID, "/latent_dims_explore.csv"))
...
ggsave(p, filename = "reproduce/img/FigureS31.pdf", width = 10, height = 5, bg = "white")