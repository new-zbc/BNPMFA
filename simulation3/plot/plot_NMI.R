...
ggsave(box_ARI, filename = "simulation3/plot/simulation_3_NMI.pdf", width = 9, height = 7)
ggsave(box_ARI, filename = "simulation3/plot/simulation_3_NMI.jpg", width = 9, height = 7)
