...
data_folder = "simulation3/scenario2_1"
...
data_folder = paste0(data_folder, "/", "p_", p)
...
load("simulation3/5_clusters_pattern.RData")
...
for(data_index in 1:50){
  ...
  mu1 = c(5.5, rep(0, q-1))
  mu2 = c(0, 5.5, rep(0, q-2))
  mu3 = c(0,0, 5.5, rep(0, q-3))
  mu4 = c(0,0,0, 5.5, rep(0, q-4))
  mu5 = c(0,0,0,0, 5.5, rep(0, q-5))
  mu = cbind(mu1, mu2, mu3, mu4, mu5)
  ...
  sce <- scater::runPCA(sce, subset_row=1:p, ncomponents=15, 
