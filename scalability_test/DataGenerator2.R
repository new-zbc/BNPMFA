...
data_folder = paste0("scalability_test/p_", p)
...
load(paste0("scalability_test/simPattern/", m, "by", m, "Pattern.RData"))
dir.create(paste0(data_folder, "/", "data"))

for(data_index in 1:20){
  
  set.seed(data_index)
  
  ground_truth = pattern$label
