...
load(file = "DLPFCdata/151672/data/151672_counts.RData")
...
timestart = Sys.time()
result = DRMFM(sce2, neighbors, index, q = 15, f = 1, n_iters = 1000, seed=1)
timeend = Sys.time()
...
save(saving, result, file = "DLPFCdata/151672/results/seed_1.RData")
save(saving, result, file = "DLPFCdata/151672/results/result_sce.RData")


load(file = "DLPFCdata/151672/results/seed_1.RData")
iter = 300
