...
load(file = "DLPFCdata/151507/data/151507_counts.RData")
...
save(saving, result, file = "DLPFCdata/151507/results/seed_1.RData")
save(sce2, file = "DLPFCdata/151507/results/result_sce.RData")