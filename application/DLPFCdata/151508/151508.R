...
load(file = "DLPFCdata/151508/data/151508_counts.RData")
...
timestart = Sys.time()
result = DRMFM(sce2, neighbors, index, q = 7, f = 1, n_iters = 1000, seed=3)
timeend = Sys.time()
...
save(saving, result, file = "DLPFCdata/151508/results/seed_3.RData")
pred_label = result$pred_label
save(pred_label, file = "DLPFCdata/151508/others/DRMFM.RData")