...
load(file = "DLPFCdata/151671/data/151671_counts.RData")
...
save(saving, result, file = "DLPFCdata/151671/results/seed_3.RData")
save(saving, result, file = "DLPFCdata/151671/results/result_sce.RData")