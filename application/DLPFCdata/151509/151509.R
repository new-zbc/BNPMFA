...
load(file = "DLPFCdata/151509/data/151509_counts.RData")
...
save(saving, result, file = "DLPFCdata/151509/results/seed_1.RData")
pred_label = result$pred_label
save(pred_label, file = "DLPFCdata/151509/others/DRMFM.RData")

#load(file = "DLPFCdata/151509/results/seed_1.RData")
#iter = 150
