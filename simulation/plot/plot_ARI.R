...
ggsave(box_ARI, filename = "simulation1/plot/simulation_1_ARI.pdf", width = 9, height = 7)
ggsave(box_ARI, filename = "simulation1/plot/simulation_1_ARI.jpg", width = 9, height = 7)
